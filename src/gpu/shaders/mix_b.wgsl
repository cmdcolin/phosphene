// Source B is a second, fully-formed NTSC generator. Two ways to combine it:
//
...
//   subcarrier is detuned off the sampling lattice. The two composites are
//   summed (optionally ring-modulated) BEFORE the channel, sync separator, and
//   burst measurement — so fighting sync, rolling bars, tilted tears, and chroma
